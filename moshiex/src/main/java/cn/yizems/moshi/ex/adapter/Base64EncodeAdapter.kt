...
public class Base64QualifierAdapter(
    ...
    companion object FACTORY : Factory {
        ...
        override fun create(
            ...
            val annotation =
                annotations.find { it is Base64Qualifier } as? Base64Qualifier ?: return null
    ...
    override fun fromJson(reader: JsonReader): String? {
        ...
        return if (decode) {
            val base64 = source.decodeBase64()
                ?: throw IllegalArgumentException("Base64 decode error: $source")
            base64.utf8()
        } else {
            source
        }
